...
所有 css 和 js 合并成了一个文件，并且多了其他代码。如果代码运行出错那么提示代码错误位置，很难去发现错误出现在哪里。  
所以需要更加准确的错误提示，来帮助我们更好的开发

### 应用

SourceMap 的值：[Webpack DevTool 文档](https://webpack.docschina.org/configuration/devtool/)
