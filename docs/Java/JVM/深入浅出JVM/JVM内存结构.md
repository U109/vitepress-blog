...
![jvm-stack](/Java系列/JVM/深入浅出JVM/jvm-stack.jpg)
...
![jvm-memory](/Java系列/JVM/深入浅出JVM/jvm-memory.png)
...
![jvm-runtime-constant-pool](/Java系列/JVM/深入浅出JVM/jvm-runtime-constant-pool.png)
...
> ![jvm-off-heap-memory](/Java系列/JVM/深入浅出JVM/jvm-off-heap-memory.png)
