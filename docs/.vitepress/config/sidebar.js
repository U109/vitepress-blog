    ...
    '/Java系列/JVM/深入浅出JVM/': [
        {
            ...
            // collapsed: true,
            items: [
                {text: '1、JVM 内存结构', link: '/Java系列/JVM/深入浅出JVM/JVM内存结构'},
                {text: '2、HotSpot虚拟机对象探秘', link: '/Java系列/JVM/深入浅出JVM/HotSpot虚拟机对象探秘'},
                {text: '3、垃圾收集策略与算法', link: '/Java系列/JVM/深入浅出JVM/垃圾收集策略与算法'},
                {text: '4、HotSpot垃圾收集器', link: '/Java系列/JVM/深入浅出JVM/HotSpot垃圾收集器'},
                {text: '5、内存分配与回收策略', link: '/Java系列/JVM/深入浅出JVM/内存分配与回收策略'},
                {text: '6、JVM性能调优', link: '/Java系列/JVM/深入浅出JVM/JVM性能调优'},
                {text: '7、类文件结构', link: '/Java系列/JVM/深入浅出JVM/类文件结构'},
                {text: '8、类加载的时机', link: '/Java系列/JVM/深入浅出JVM/类加载的时机'},
                {text: '9、类加载的过程', link: '/Java系列/JVM/深入浅出JVM/类加载的过程'},
                {text: '10、类加载器', link: '/Java系列/JVM/深入浅出JVM/类加载器'},
            ],
        }
    ],
    '/数据库/书籍鉴赏/': [
