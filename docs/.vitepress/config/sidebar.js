    ...
    '/数据库/书籍鉴赏/': [
        {
            ...
            collapsed: true,
            items: [
                {text: '字符集和比较规则简介', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/字符集和比较规则/字符集和比较规则简介'},
                {
                    text: 'MySQL支持的字符集和排序规则',
                    link: '/数据库/书籍鉴赏/MySQL是怎样运行的/字符集和比较规则/MySQL支持的字符集和排序规则'
                },
                {text: '字符集和比较规则的应用', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/字符集和比较规则/字符集和比较规则的应用'},
        ...
        },
        {
            ...
            collapsed: true,
            items: [
                {text: '不同类型的页简介', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/InnoDB数据页结构/不同类型的页简介'},
                {text: '数据页结构的快速浏览', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/InnoDB数据页结构/数据页结构的快速浏览'},
                {text: '记录在页中的存储', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/InnoDB数据页结构/记录在页中的存储'},
                {text: 'Page Directory（页目录）', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/InnoDB数据页结构/Page Directory（页目录）'},
                {text: 'Page Header（页面头部）', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/InnoDB数据页结构/Page Header（页面头部）'},
                {text: 'File Header（文件头部）', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/InnoDB数据页结构/File Header（文件头部）'},
        ...
        },
        {
            ...
            items: [
                ...
                {text: 'B+树索引适用的条件', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/B+树索引的使用/B+树索引适用的条件'},
        ...
        },
        {
            ...
            collapsed: true,
            items: [
                {text: '数据库和文件系统的关系', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/MySQL的数据目录/数据库和文件系统的关系'},
                {text: 'MySQL数据目录', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/MySQL的数据目录/MySQL数据目录'},
                {text: '数据目录的结构', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/MySQL的数据目录/数据目录的结构'},
                {text: '文件系统对数据库的影响', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/MySQL的数据目录/文件系统对数据库的影响'},
                {text: 'MySQL系统数据库简介', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/MySQL的数据目录/MySQL系统数据库简介'},
            ],
        },
        {
            text: 'InnoDB的表空间',
        ...
        },
        {
            ...
            collapsed: true,
            items: [
                {text: '访问方法（access method）的概念', link: '/数据库/书籍鉴赏/MySQL是怎样运行的/单表访问方法/访问方法（access method）的概念'},
