    ...
    '/分布式/消息队列/RabbitMQ/': [
        {
            ...
            items: [
                ...
                {text: '1.5、消息队列的高可用和高可靠', link: '/分布式/消息队列/RabbitMQ/MQ相关的概念/消息队列的高可用和高可靠'},
            ],
        },
        {
            text: '二、RabbitMQ安装启动',
            ...
            items: [
                ...
                {text: '2.3、RabbitMQWeb管理界面及授权操作', link: '/分布式/消息队列/RabbitMQ/RabbitMQ安装启动/RabbitMQWeb管理界面及授权操作'},
        ...
        },
        {
            ...
            items: [
                ...
                {text: '7.3、Haproxy+Keepalive实现高可用负载均衡', link: '/分布式/消息队列/RabbitMQ/RabbitMQ集群/Haproxy+Keepalive实现高可用负载均衡'},
